...
docker run -it --platform linux/amd64 \
  ...
  bash -c '
    ...
    && cd /home/buildozer \
    && if [ -e huafetcher ]; then cd huafetcher; git checkout v0.26; git reset --hard; git pull; else git clone https://codeberg.org/vanous/huafetcher.git; cd huafetcher; fi \
